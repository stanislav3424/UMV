...
// Begin Class AMainController Function GetSelectedUnits
struct Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics
{
	struct MainController_eventGetSelectedUnits_Parms
	{
		TSet<AUnit*> ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Selection" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::NewProp_ReturnValue_ElementProp = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AUnit_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FSetPropertyParams Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MainController_eventGetSelectedUnits_Parms, ReturnValue), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::NewProp_ReturnValue_ElementProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMainController, nullptr, "GetSelectedUnits", nullptr, nullptr, Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::MainController_eventGetSelectedUnits_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::MainController_eventGetSelectedUnits_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMainController_GetSelectedUnits()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMainController_GetSelectedUnits_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMainController::execGetSelectedUnits)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TSet<AUnit*>*)Z_Param__Result=P_THIS->GetSelectedUnits();
	P_NATIVE_END;
}
// End Class AMainController Function GetSelectedUnits
...
void AMainController::StaticRegisterNativesAMainController()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "GetSelectedUnits", &AMainController::execGetSelectedUnits },
	};
...
struct Z_Construct_UClass_AMainController_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMainController_GetSelectedUnits, "GetSelectedUnits" }, // 554909777
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMainController_Statics::NewProp_SelectedUnits_ElementProp = { "SelectedUnits", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AUnit_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMainController_Statics::NewProp_NewSelectedUnits_ElementProp = { "NewSelectedUnits", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AUnit_NoRegister, METADATA_PARAMS(0, nullptr) };
...
struct Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_UMV_Source_UMV_MainController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMainController, AMainController::StaticClass, TEXT("AMainController"), &Z_Registration_Info_UClass_AMainController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMainController), 1277567366U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_UMV_Source_UMV_MainController_h_2262595189(TEXT("/Script/UMV"),
